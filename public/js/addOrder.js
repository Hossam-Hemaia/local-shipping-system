...
const createOne = () => {
  ...
  const template = `<div class="card">
        ...
        <div class="all-result">
            ...
            <input type="text" name="landmark" placeholder="علامه مميزه للمكان" value="${specialMark.value}">
            <input type="text" name="productName" placeholder="اسم المنتج" class="productName" value="${productName.value}">
            <input type="number" name="productPrice" placeholder="سعر المنتج" class="productPrice" value="${productPrice.value}">
            <input type="text" name="note" placeholder="ملحوظه بخصوص المنتج" class="note" value="${Note.value}">
            <div class="select--container">
                ...
                <div class="time-select">
                    ...
                    <select name="deliveryType" class="time-container${counter}">
                        <option value="dw">من 48 الى 72 ساعه</option>
                        <option value="sd">نفس اليوم</option>
                    </select>
                </div>
            </div>
            <div class="center">
