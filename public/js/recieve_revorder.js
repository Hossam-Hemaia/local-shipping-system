...
cardsContainer.addEventListener('click', (e)=>{
    ...
    if(e.target.classList.contains('options-dots')){
        ...
        // btn card
        const cardSubmit = e.target.parentNode.parentNode.querySelector('.card-submit');
        // input fee
        const deliveryFee = cardSubmit.parentNode.querySelector('.deliveryFee');
        // input client name
        ...
        cardSubmit.addEventListener('click', (e3)=>{
            ...
            e3.target.parentNode.parentNode.parentNode.classList.remove('full-options');

            // mini name
            const miniName = e3.target.parentNode.parentNode.previousElementSibling.querySelector('.card_name');
            // mini product name
            const miniProductName = e3.target.parentNode.parentNode.previousElementSibling.querySelector('.product_name');
            // mini product price
            const miniProductPrice = e3.target.parentNode.parentNode.previousElementSibling.querySelector('.product_price');
